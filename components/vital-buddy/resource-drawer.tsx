...
const RESOURCES: Resource[] = [
  {
    ...
    type: "exercise",
    content_url: "https://vimeo.com/1178026091",
    duration_mins: 5,
  ...
  },
  {
    ...
    type: "exercise",
    content_url: "https://vimeo.com/1178023823",
    duration_mins: 5,
    category: "guilt"
  },
  {
  ...
  },
  {
    ...
    type: "breathing",
    content_url: "https://vimeo.com/1178026630",
    duration_mins: 3,
    category: "sleep"
  },
  {
  ...
  },
  {
    ...
    type: "grounding",
    content_url: "https://vimeo.com/1178027075",
    duration_mins: 2,
    category: "grounding"
  }
];
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-4">
          ...
          <div className="flex flex-col gap-3 mt-1">
            {filtered.map((r) => {
              ...
              const thumbnail = vimeoId ? getVimeoThumbnail(vimeoId) : undefined;
                  ...
                  <div className="p-3">
                    <div className="flex items-start gap-2">
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs leading-relaxed mb-1.5" style={{ color: "var(--foreground-subtle)" }}>
                          {r.description}
                        </p>
                        <div className="flex items-center gap-2">
                          <span className="text-xs px-2 py-0.5 rounded" style={{ background: "#f5f5f5", color: "var(--foreground-ghost)" }}>
                            {r.duration_mins} min
                          </span>
                          {isPlaying && (
                            <button

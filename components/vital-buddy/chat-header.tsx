    ...
    <header className="flex flex-col border-b border-border bg-card shrink-0">
      ...
      <div className="flex items-center gap-2 px-3 pt-2.5 pb-1.5">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-medium tracking-tight leading-tight">Vital Buddy</p>
        ...
        <div className="flex items-center gap-1.5 px-3 pb-2">
          {openScore !== null && (
            <div
              ...
              style={{ background: "var(--surface-secondary)", color: "var(--foreground-ghost)", fontSize: "11px" }}
            >
              Opened at{" "}

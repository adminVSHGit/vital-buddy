  ...
  return (
    ...
    >
      ...
      <nav className="grid grid-cols-2 md:flex md:justify-center gap-x-3 gap-y-0.5 md:gap-5 mt-1" aria-label="Footer links">
        <a href="https://vitalstarthealth.com/about/#contact" target="_blank" rel="noopener noreferrer" className="cursor-pointer hover:underline text-left md:text-center" style={{ color: "var(--brand)", fontSize: "10px" }}>
          Connect to support
        </a>
        ...
        <a href="https://vitalstarthealth.com/terms-of-service/" target="_blank" rel="noopener noreferrer" className="cursor-pointer hover:underline text-left md:text-center" style={{ color: "var(--brand)", fontSize: "10px" }}>
          Terms &amp; conditions
        </a>
        <a href="https://988lifeline.org/?utm_source=google&utm_medium=web&utm_campaign=onebox" target="_blank" rel="noopener noreferrer" className="cursor-pointer hover:underline text-left md:text-center" style={{ color: "var(--danger)", fontSize: "10px" }}>
          988 Crisis Lifeline
        </a>
      </nav>
    </footer>
